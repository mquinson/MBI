...
operation['MPI_Send'] = lambda n: f'MPI_Send(buf{n}, buff_size, MPI_INT, dest, stag, MPI_COMM_WORLD);'
...
operation['MPI_Recv'] = lambda n: f'MPI_Recv(buf{n}, buff_size, MPI_INT, src, rtag, MPI_COMM_WORLD, &sta{n});'
...
operation['MPI_Isend'] = lambda n: f'MPI_Isend(buf{n}, buff_size, MPI_INT, dest, stag, MPI_COMM_WORLD, &req{n});'
...
operation['MPI_Irecv'] = lambda n: f'MPI_Irecv(buf{n}, buff_size, MPI_INT, src, rtag, MPI_COMM_WORLD, &req{n});'
...
operation['MPI_Send_init'] = lambda n: f'MPI_Send_init(buf{n}, buff_size, MPI_INT, dest, stag, MPI_COMM_WORLD, &req{n});' 
...
operation['MPI_Recv_init'] = lambda n: f'MPI_Recv_init(buf{n}, buff_size, MPI_INT, src, rtag, MPI_COMM_WORLD, &req{n});'
