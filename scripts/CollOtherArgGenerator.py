...
for op in toolfunc: 
    ...
    patterns['op'] = op
    patterns['operation1'] = operation[op]("1")
    patterns['operation2'] = operation[op]("2")

    # Generate the code with invalid color
    replace = patterns
    replace['shortdesc'] = 'Invalid color in @{op}@'
    replace['longdesc'] = f'invalid color in @{op}@'
