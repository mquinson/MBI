...
free['MPI_Ireduce'] = lambda n: f"free(req{n});"
...
for s in isend + perssend:
    for r in irecv + persrecv:
        ...
        patterns['persfeature'] = 'Correct' if s in perssend or r in persrecv  else 'Lacking'
        patterns['ip2pfeature'] = 'Correct' if s in isend or r in irecv  else 'Lacking' 
...
for c in pers + icoll:
    ...
    patterns['cpersfeature'] = 'Correct' if c in pers else 'Lacking'
    patterns['icollfeature'] = 'Correct' if c in icoll else 'Lacking'
    patterns['c'] = c
    ...
    patterns['free2'] = "" 
		...
		# Generate the code with a missing wait - collective only
    replace = patterns
    replace['shortdesc'] = 'Missing wait'
    ...
    make_file(template, f'MissingWait_{c}_nok.c', replace)
		...
		# Generate the code with a missing start - collective only
		# Generate the code with a resleak (no free) - collective only
