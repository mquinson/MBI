...
for p in get:
    for s in send + isend:
         for r in recv + irecv:
             ...
             patterns['operation2'] = operation[s]("2").replace("buf2", "localbuf1")
             ...
             make_file(template, f'LocalConcurrency_fence_{p}_{s}_{r}_nok.c', replace)
             ...
             make_file(template, f'LocalConcurrency_lock_{p}_{s}_{r}_nok.c', replace)
