...
fini['MPI_Ibarrier'] = lambda n: f'MPI_Request_free(&req{n});'
...
fini['MPI_Ibcast'] = lambda n: f'MPI_Request_free(&req{n});'
...
fini['MPI_Ireduce'] = lambda n: f'MPI_Request_free(&req{n});'
