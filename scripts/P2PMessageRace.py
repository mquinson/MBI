...
write['MPI_Irecv'] = lambda n: f'buf{n}=4;' 
...
write['MPI_Recv_init'] = lambda n: f'buf{n}=4;' 
...
for s in send:
    for r in irecv + precv:
        ...
        # Generate the message race
        replace = patterns 
        replace['shortdesc'] = 'Message Race'
        replace['longdesc'] = f'The buffer in {r} is modified before the call has been completed.'
...
for s in isend + psend:
    for r in recv:
        ...
        patterns['persfeature'] = 'Yes' if s in psend else 'Lacking'
        patterns['s'] = s
        patterns['r'] = r
        patterns['init1'] = init[s]("1")
        patterns['init2'] = init[r]("2")
        ...
        replace = patterns 
        replace['shortdesc'] = 'Message Race'
        replace['longdesc'] = f'The buffer in {s} is modified before the call has been completed.'
        replace['outcome'] = 'ERROR: MessageRace' 
