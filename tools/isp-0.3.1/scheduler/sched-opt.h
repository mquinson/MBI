...
typedef enum {
    ...
    INDEX_OPT_FIBOPT              = 12,
    INDEX_OPT_VIEW_PROG_OUT_ONLY  = 13,
    INDEX_OPT_DISABLE_OMP         = 14,
    INDEX_OPT_EXP_MODE            = 15,
    INDEX_OPT_ENV                 = 16,
    INDEX_OPT_EXP_SOME            = 17,
    INDEX_OPT_STOP_AT_DEADLOCK    = 18,
    INDEX_OPT_DEBUG_SCHED         = 19,
    INDEX_OPT_NO_AMPLE_SET_FIX    = 20,
    INDEX_OPT_BOUND               = 21,
    INDEX_OPT_FPRS                = 22,
...
#define OPTION_CT    26
#define ISP_VERSION       "0.3.0"
#define ISP_FULL_VERSION  "isp - isp: In-Situ Partial Order - Ver. 0.3.0"
...
#define VALUE_OPT_DEBUG_SCHED    19
