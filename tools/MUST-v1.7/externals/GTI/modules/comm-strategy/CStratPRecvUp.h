...
#ifndef CSTRAT_PRECV_UP_H
#define CSTRAT_PRECV_UP_H
...
namespace gti
{
     ...
     */
    class CStratPRecvUp : public ModuleBase<CStratPRecvUp, CStratUpQueue>, public CStratPRecvSender
    {
    protected:
    ...
    public:
         ...
         */
        CStratPRecvUp (const char* instanceName);

        /**
         * Destructor.
         */
        virtual ~CStratPRecvUp ();
